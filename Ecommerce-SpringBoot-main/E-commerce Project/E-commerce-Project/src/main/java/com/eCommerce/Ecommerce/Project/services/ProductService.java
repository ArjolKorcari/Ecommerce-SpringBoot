...
//	    // Method to customize products based on provided parameters
//	    public void customizeProducts(Product product) {
//	        for (Product product : products) {
//	            // If id is specified, update only the specified product
//	            if (id != null && product.getId() == id) {
//	                if (name != null) product.setName(name);
//	                if (imageUrl != null) product.setImage(imageUrl);
//	                if (categoryId != null) product.setCategory(category(categoryId));
...
//	BufferedImage image= readFromFile();
//	
//	
//	
//	private static BufferedImage readFromFile(int width , int height, BufferedImage bufferedImage) throws IOException {
//		File sampleFile= new File("C:/Users/USER/Downloads/Porsche-911-Sport-Classic-1024x592.jpeg");
